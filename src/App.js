...
const HelpModal = ({ onClose }) => {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 text-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6">
                <div className="flex justify-between items-center border-b border-gray-700 pb-4 mb-4">
                    <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">How to Use the Tracker</h2>
                    <button onClick={onClose} className="text-gray-400 hover:text-white text-2xl">&times;</button>
                </div>

                <div className="space-y-6">
                    <section>
                        <h3 className="text-xl font-semibold mb-2 text-green-400">1. Starting a Session</h3>
                        <p className="text-gray-300">Before the game begins, you have several options to configure your session:</p>
                        <ul className="list-disc list-inside space-y-2 mt-2 text-gray-300">
                            <li><strong>Set Bankroll:</strong> Enter your starting cash. Defaults to $600.</li>
                            <li><strong>Set the Point (Optional):</strong> If you're starting mid-game, you can set the point before placing bets.</li>
                            <li><strong>Set Max Bet (Optional):</strong> Set a ceiling for your bets. The app will automatically collect winnings once a bet reaches this limit. Defaults to $1000.</li>
                            <li><strong>Betting Strategy:</strong> Choose your preferred play style. This determines how the app will automatically handle your bets.</li>
                        </ul>
                    </section>

                    <section>
                        <h3 className="text-xl font-semibold mb-2 text-green-400">2. Understanding the Display</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div className="bg-gray-700 p-3 rounded-lg">
                                <h4 className="font-bold text-yellow-400">Shooter Status</h4>
                                <ul className="list-disc list-inside ml-2 mt-1 text-gray-300">
                                    <li><strong>Bet on Table:</strong> Total money currently at risk.</li>
                                    <li><strong>Point Winnings:</strong> Total winnings collected for the current point only. Resets when a point is hit.</li>
                                    <li><strong>Shooter P/L:</strong> Your true profit/loss for the current shooter's entire turn, based on your bankroll.</li>
                                    <li><strong>Points Made:</strong> A history of points the current shooter has successfully made, and the profit from each.</li>
                                </ul>
                            </div>
                            <div className="bg-gray-700 p-3 rounded-lg">
                                <h4 className="font-bold text-yellow-400">Session Bankroll</h4>
                                <ul className="list-disc list-inside ml-2 mt-1 text-gray-300">
                                    <li><strong>Starting:</strong> The bankroll you began the entire session with.</li>
                                    <li><strong>Current:</strong> The actual cash you have "in your rack."</li>
                                    <li><strong>Session P/L:</strong> The true profit/loss for your entire session (Current - Starting Bankroll).</li>
                                </ul>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        <h3 className="text-xl font-semibold mb-2 text-green-400">3. The "Duck Ragu" Automated Strategy</h3>
                        <p className="text-gray-300 mb-4">Duck Ragu is a special, two-phase "opening" strategy. The app manages your bets according to the flowchart below. Once the strategy completes (by reaching "$64 Across"), it automatically switches to your chosen standard press/collect strategy for the rest of the shooter's roll.</p>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
                            {/* Phase 1 */}
                            <div>
                                <h4 className="font-bold text-center mb-2 text-blue-400">Phase 1: Left Side (Start)</h4>
                                <div className="bg-gray-900 p-3 rounded-lg border border-gray-700 text-center space-y-2">
                                    <div className="bg-blue-600 p-2 rounded">START: $12 on 6 & 8</div>
                                    <div>↓</div>
                                    <div className="bg-gray-700 p-2 rounded">First Hit → Power Press to $30 (becomes "Hot")</div>
                                    <div>↓</div>
                                    <div className="border-2 border-dashed border-gray-600 rounded p-2">
                                        <p className="font-bold">If 'Cold' ($12) Hits Next...</p>
                                        <div className="bg-red-500 p-2 rounded mt-1">→ RESET TO PHASE 2</div>
                                    </div>
                                    <div className="border-2 border-dashed border-gray-600 rounded p-2">
                                        <p className="font-bold">If 'Hot' ($30) Hits Next...</p>
                                        <div className="bg-green-600 p-2 rounded mt-1">Collect Winnings</div>
                                        <div>↓</div>
                                        <div className="grid grid-cols-2 gap-2 mt-1">
                                            <div>
                                                <p className="font-bold mb-1">If 'Cold' ($12) Hits...</p>
                                                <div className="bg-yellow-500 text-black p-2 rounded h-full flex items-center justify-center">Press both to $30</div>
                                            </div>
                                            <div>
                                                <p className="font-bold mb-1">If 'Hot' ($30) Hits Again...</p>
                                                <div className="bg-purple-600 p-2 rounded h-full flex items-center justify-center">→ GO ACROSS</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* Phase 2 */}
                            <div>
                                <h4 className="font-bold text-center mb-2 text-red-400">Phase 2: Right Side (After Reset)</h4>
                                <div className="bg-gray-900 p-3 rounded-lg border border-gray-700 text-center space-y-2">
                                    <div className="bg-blue-600 p-2 rounded">START: $12 on 6 & 8</div>
                                    <div>↓</div>
                                    <div className="bg-gray-700 p-2 rounded">First Hit → Power Press to $30 (becomes "Hot")</div>
                                    ...
                                    <div className="border-2 border-dashed border-gray-600 rounded p-2">
                                        <p className="font-bold">If 'Cold' ($12) Hits Next...</p>
                                        <div className="bg-yellow-500 text-black p-2 rounded mt-1">Press both to $30</div>
                                    </div>
                                    <div className="border-2 border-dashed border-gray-600 rounded p-2">
                                        <p className="font-bold">If 'Hot' ($30) Hits Next...</p>
                                        <div className="bg-purple-600 p-2 rounded mt-1">→ GO ACROSS</div>
                                    </div>
                                    <div className="border-2 border-dashed border-gray-600 rounded p-2 mt-4">
                                        <p className="font-bold">If EITHER hits after both are $30...</p>
                                        <div className="bg-purple-600 p-2 rounded mt-1">→ GO ACROSS</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="border-t border-gray-700 mt-6 pt-4 text-right">
...
export default function App() {
    ...
    // Strategy State
    const [mainStrategy, setMainStrategy] = useState('standard');
    const [pressType, setPressType] = useState('regular');
    const [firstAction, setFirstAction] = useState('collect');
    ...
    const handleSetInitialBets = () => {
        ...
        if (mainStrategy === 'duck_ragu') betsToPlace = DUCK_RAGU_START_BETS;
    ...
    const handleDuckRaguComplete = (payoutFromFinalHit) => {
        addMessage("Duck Ragu strategy complete. Switching to standard strategy.", "info");
        setDuckRaguState({ isActive: false, phase: 'left', hotNumber: null, hasCollected: false });

        const costOfNewBets = Object.values(GO_ACROSS_BETS).reduce((s, b) => s + b, 0);
        const currentTotalBet = totalBet;
        setBankroll(prev => prev + payoutFromFinalHit + currentTotalBet - costOfNewBets);
        setBets(GO_ACROSS_BETS);

        const newTracker = {};
        Object.keys(GO_ACROSS_BETS).forEach(numStr => {
            const num = parseInt(numStr, 10);
            if (GO_ACROSS_BETS[num] > 0) newTracker[num] = firstAction === 'collect' ? 'collect' : pressType;
        });
        setStrategyTracker(newTracker);
    };
    ...
    const saveStateToHistory = () => {
        const currentState = {
            ...
            messages: [...messages],
            duckRaguState: { ...duckRaguState },
            bankrollAtShooterStart
        };
    ...
    const handleUndo = () => {
        ...
        setBets(lastState.bets);
        setBankroll(lastState.bankroll);
        setPoint(lastState.point);
        setStrategyTracker(lastState.strategyTracker);
        setPointWinnings(lastState.pointWinnings);
        setPointHistory(lastState.pointHistory);
        setMessages(lastState.messages);
        setDuckRaguState(lastState.duckRaguState);
        setBankrollAtShooterStart(lastState.bankrollAtShooterStart);
        setHistoryStack(prev => prev.slice(0, -1));
        addMessage("--- Last roll undone ---", "info");
    };

    const handlePointChange = (newPoint) => {
        setPoint(newPoint);
        setIsEditingPoint(false);
        addMessage(`Point manually changed to ${newPoint === null ? 'OFF' : newPoint}.`, 'info');
    };
    ...
    const handleRoll = (rollValue) => {
        ...
        let wasHit = bets[rollValue] > 0;
        let wasPointHit = rollValue === point;
        ...
        if (wasHit) {
            ...
            if (duckRaguState.isActive && (rollValue === 6 || rollValue === 8)) {
                if (duckRaguState.phase === 'left') {
                    if (!duckRaguState.hotNumber) {
                        const pressTo = POWER_PRESS_SCHEDULE['6_8'][12];
                        const cost = pressTo - 12;
                        setBets(prev => ({ ...prev, [rollValue]: pressTo }));
                        setBankroll(prev => prev + (payout - cost));
                        setDuckRaguState(prev => ({ ...prev, hotNumber: rollValue }));
                        addMessage(`Duck Ragu: First hit. Power pressed ${rollValue} to $${pressTo}. Collected $${(payout - cost).toFixed(2)}.`, 'info');
                    } else if (rollValue === duckRaguState.hotNumber) {
                        if (!duckRaguState.hasCollected) {
                        ...
                        if (!duckRaguState.hasCollected) {
                            ...
                            setDuckRaguState(prev => ({ ...prev, phase: 'right', hotNumber: null, hasCollected: false }));
                ...
                if (!action) {
                    ...
                    addMessage(`Hit on ${rollValue}! Bet was $${betAmount.toFixed(2)}. Action: ${action.replace('_', ' ').toUpperCase()}.`, 'win');
                    ...
                    if (action === 'collect') {
                        ...
                        if (action === 'power') {
                            ...
                            newBetAmount = pressTo || betAmount * 2;
        ...
        if (wasPointHit) {
            setPointHistory(prev => [...prev, { point, profit: pointWinnings + (bets[rollValue] > 0 ? (bets[rollValue] * PLACE_PAYOUTS[rollValue]) : 0) }]);
            setPoint(null);
            setPointWinnings(0);
        ...
        <div className="bg-gray-900 text-white min-h-screen font-sans p-4 sm:p-6 lg:p-8">
            ...
            <div className="max-w-7xl mx-auto">
                <header className="text-center mb-8 relative">
                    ...
                    <button onClick={() => setIsHelpModalOpen(true)} className="absolute top-0 right-0 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-colors">
                        Help
                    </button>
                </header>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        {initialBets === null && (
                            <>
                                {initialBankroll === null && (
                                    <>
                                        <div>
                                            ...
                                            <div className="bg-gray-800 p-4 rounded-lg flex items-center gap-4"><label htmlFor="bankroll" className="text-gray-400">Starting Bankroll:</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">$</span><input id="bankroll" type="number" value={bankrollInput} onChange={(e) => setBankrollInput(e.target.value)} placeholder="600" disabled={initialBankroll !== null} className="bg-gray-700 text-white w-36 text-center rounded-md p-2 pl-7 border border-gray-600 focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:opacity-70" /></div></div>
                                        </div>
                                        <div>
                                            <h2 className="text-2xl font-semibold mb-4 border-b-2 border-gray-700 pb-2">2. Set the Point (Optional)</h2>
                                            <div className="flex flex-wrap gap-3 items-center bg-gray-800 p-4 rounded-lg"><p className="text-gray-400 mr-2">Start with point ON:</p>{[4, 5, 6, 8, 9, 10].map(p => (<button key={p} onClick={() => setPoint(p)} className={`w-12 h-12 text-xl font-bold rounded-lg transition-colors ${point === p ? 'bg-blue-600 text-white ring-2 ring-blue-400' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}>{p}</button>))}</div>
                                        </div>
                                        <div>
                                            <h2 className="text-2xl font-semibold mb-4 border-b-2 border-gray-700 pb-2">3. Set Max Bet (Optional)</h2>
                                            <div className="bg-gray-800 p-4 rounded-lg flex items-center gap-4"><label htmlFor="max-bet" className="text-gray-400">Max bet per number:</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">$</span><input id="max-bet" type="number" value={maxBet} onChange={(e) => setMaxBet(e.target.value)} placeholder="1000" className="bg-gray-700 text-white w-36 text-center rounded-md p-2 pl-7 border border-gray-600 focus:ring-2 focus:ring-blue-500 focus:outline-none" /></div></div>
                                        </div>
                                        <div>
                                            ...
                                            <div className="bg-gray-800 p-4 rounded-lg flex flex-col gap-4">
                                                ...
                                                {mainStrategy === 'standard' ? (
                                                    <>
                                                        <div className="flex items-center gap-4"><p className="text-gray-400 w-28">Press Type:</p><button onClick={() => setPressType('regular')} className={`px-4 py-2 text-md font-bold rounded-lg transition-colors ${pressType === 'regular' ? 'bg-yellow-500 text-white ring-2 ring-yellow-300' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}>Regular Press</button><button onClick={() => setPressType('power')} className={`px-4 py-2 text-md font-bold rounded-lg transition-colors ${pressType === 'power' ? 'bg-red-600 text-white ring-2 ring-red-400' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}>Power Press</button></div>
                                                        <div className="flex items-center gap-4"><p className="text-gray-400 w-28">On First Hit:</p><button onClick={() => setFirstAction('collect')} className={`px-4 py-2 text-md font-bold rounded-lg transition-colors ${firstAction === 'collect' ? 'bg-green-600 text-white ring-2 ring-green-400' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}>Collect First</button><button onClick={() => setFirstAction('press')} className={`px-4 py-2 text-md font-bold rounded-lg transition-colors ${firstAction === 'press' ? 'bg-yellow-500 text-white ring-2 ring-yellow-300' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}>Press First</button></div>
                                                    </>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-3 bg-gray-800 p-4 rounded-lg">{CHIP_DENOMINATIONS.map(chip => (<button key={chip} onClick={() => setSelectedChip(chip)} className={`h-14 w-14 rounded-full font-bold text-lg flex items-center justify-center border-4 transition-all transform hover:scale-110 ${chip === 0.5 ? 'bg-white text-black border-gray-400' : ''} ${chip === 1 ? 'bg-blue-200 text-blue-800 border-blue-400' : ''} ${chip === 2 ? 'bg-yellow-200 text-yellow-800 border-yellow-400' : ''} ${chip === 5 ? 'bg-red-500 text-white border-red-300' : ''} ${chip === 10 ? 'bg-blue-500 text-white border-blue-300' : ''} ${chip === 25 ? 'bg-green-500 text-white border-green-300' : ''} ${chip === 50 ? 'bg-orange-500 text-white border-orange-300' : ''} ${chip === 100 ? 'bg-black text-white border-gray-400' : ''} ${selectedChip === chip ? 'ring-4 ring-offset-2 ring-offset-gray-800 ring-yellow-400' : ''}`}>{chip < 1 ? '50¢' : `$${chip}`}</button>))}</div>
                                </div>
                                {mainStrategy === 'standard' && (
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-4 border-b-2 border-gray-700 pb-2">{initialBankroll === null ? '6.' : '2.'} Quick Bets</h2>
                                        <div className="bg-gray-800 p-4 rounded-lg flex items-center flex-wrap gap-2"><p className="text-gray-400 mr-4">Based on selected chip:</p><button onClick={handleBetAcross} className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg transition-colors">Bet Across</button><button onClick={handleBetInside} className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg transition-colors">Bet Inside</button><button onClick={handleBetOutside} className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg transition-colors">Bet Outside</button><button onClick={handleBetPoles} className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg transition-colors">Bet Poles</button></div>
                                    </div>
                                )}
                            </>
                        )}
                        <div>
                            <h2 className="text-2xl font-semibold mb-4 border-b-2 border-gray-700 pb-2">{mainStrategy === 'duck_ragu' ? 'Duck Ragu Starting Bets' : (initialBets === null ? `${initialBankroll === null ? '7.' : '3.'} Place Your Bets` : 'Current Bets')}</h2>
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">{[4, 5, 6, 8, 9, 10].map(num => <BetInput key={num} number={num} />)}</div>
                        </div>
                        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                            {initialBets === null ? (
                                <>{mainStrategy === 'standard' && <button onClick={handleClearAllBets} className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded-lg text-lg transition-transform transform hover:scale-105 mb-4">Clear All Bets</button>}<button onClick={handleSetInitialBets} className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-bold py-3 px-4 rounded-lg text-lg transition-transform transform hover:scale-105">{initialBankroll === null ? 'Start Session' : 'Lock In Bets for New Shooter'}</button></>
                            ) : (
                                <div><h3 className="text-xl font-semibold text-center mb-4">Enter Next Roll</h3><div className="flex flex-wrap justify-center gap-3">{POSSIBLE_ROLLS.map(rollNum => (<button key={rollNum} onClick={() => handleRoll(rollNum)} className={`w-16 h-16 text-2xl font-bold rounded-lg transition-transform transform hover:scale-110 ${rollNum === 7 ? 'bg-red-600 hover:bg-red-500 text-white' : 'bg-blue-600 hover:bg-blue-500 text-white'}`}>{rollNum}</button>))}</div></div>
                            )}
                            {initialBankroll !== null && (
                                <div className="flex items-center justify-center mt-6 gap-4">
                                    <button onClick={handleUndo} disabled={historyStack.length === 0} className="bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-3 px-6 rounded-lg transition-colors disabled:bg-gray-600 disabled:cursor-not-allowed">Undo Last Roll</button>
                                    <button onClick={handleResetGame} className="bg-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-6 rounded-lg transition-colors">Reset Session</button>
                                </div>
                            )}
                        </div>
                    </div>
                    <div className="bg-gray-800 p-6 rounded-lg shadow-lg space-y-6">
                        ...
                        <div className="flex flex-col gap-2 text-center"><div className="grid grid-cols-2 gap-2"><div className="bg-gray-700 p-2 rounded-lg"><div className="text-xs text-gray-400">Bet on Table</div><div className="text-lg font-bold text-yellow-400">{`$${totalBet.toFixed(2)}`}</div></div><div className="bg-gray-700 p-2 rounded-lg"><div className="text-xs text-gray-400">Point Winnings</div><div className={`text-lg font-bold ${pointPL >= 0 ? 'text-green-400' : 'text-red-400'}`}>{`$${pointPL.toFixed(2)}`}</div></div></div><div className="bg-gray-700 p-2 rounded-lg"><div className="text-xs text-gray-400">Shooter P/L</div><div className={`text-lg font-bold ${shooterPL >= 0 ? 'text-green-400' : 'text-red-400'}`}>{shooterPL >= 0 ? `$${shooterPL.toFixed(2)}` : `-$${Math.abs(shooterPL).toFixed(2)}`}</div></div></div>
                        <div className="text-center bg-gray-700 p-4 rounded-lg cursor-pointer" onClick={() => initialBankroll && setIsEditingPoint(true)}>
                            <div className="text-sm text-gray-400">Point</div>
                            {isEditingPoint ? (
                                <div className="flex flex-wrap justify-center gap-2 mt-2">
                                    {[...POSSIBLE_ROLLS.filter(r => [4, 5, 6, 8, 9, 10].includes(r)), null].map(p => (
                                        <button key={p || 'off'} onClick={(e) => { e.stopPropagation(); handlePointChange(p); }} className="bg-blue-600 hover:bg-blue-500 text-white font-bold py-2 px-3 rounded text-lg">{p || 'OFF'}</button>
                                    ))}
                                </div>
                            ) : (
                                <div className={`text-5xl font-bold ${point ? 'text-white' : 'text-gray-500'}`}>{point || 'OFF'}</div>
                            )}
                        </div>
